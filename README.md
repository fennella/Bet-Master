...
3) After cloning this repo, be sure you are in the root directory (where requirements.txt exists). To install all of the Python packages required to run this application run the command:
